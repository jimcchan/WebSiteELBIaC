...
resource "aws_autoscaling_policy" "mainweb-asg-policy-1" {
...
resource "aws_launch_configuration" "mainweb-lc" {
  name = "mainweb-lc"
...
resource "aws_security_group" "mainweb-lc-sg" {
  name = "mainweb-lc-sg"
...
resource "aws_security_group" "mainweb-elb-sg" {
  name = "mainweb-elb-sg"
